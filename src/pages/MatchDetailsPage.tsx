...
import { createColumnHelper, getCoreRowModel, useReactTable, flexRender, getPaginationRowModel, SortingState, getSortedRowModel } from '@tanstack/react-table'
...
const MatchDetailsPage = () => {
  ...
  const selectedTuteeMatches: selectedTuteeSlice = useSelector((state: {selectedTuteeMatches: selectedTuteeSlice})=>state.selectedTuteeMatches)
  ...
  const tuteeRow: DetailsTableData = {
    ...
    gender: (selectedTuteeMatches.tutee.personalData?.gender + " — " + selectedTuteeMatches.tutee.preferedGender), 
          ...
          <Table>
                        ...
                        >
                          ...
                          )}
                          {
                            header.column.getCanSort() ? (
                              <span>
                                {{
                                  asc: (<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 14">
                                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13V1m0 0L1 5m4-4 4 4"/>
                                </svg>),
                                  desc: (<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 14">
                                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 1v12m0 0 4-4m-4 4L1 9"/>
                                </svg>),
                                  false: (<svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 20">
            ...
            <Table.Body className={rows.length > 0 ? "border-b" : ""}>
              <Table.Row>
                ...
                <Table.Cell>{tuteeRow.gender}</Table.Cell>
