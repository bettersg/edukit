...
const initialState = [
  {
    ...
    tutor1: { index: 0, matchingScore: 1 },
    tutor2: { index: 0, matchingScore: 1 },
    tutor3: { index: 0, matchingScore: 1 },
    tutor4: { index: 0, matchingScore: 1 },
    tutor5: { index: 0, matchingScore: 1 },
  },
];
