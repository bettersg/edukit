...
import {
    ...
    educationLevelSubjectMappingMapping,
    streamMapping,
    finAidMapping,
} from '../mappingData/KSGeneralTutee';

export default class KSGeneralTuteeFormat
    extends GenericFormat
    implements DataFormatter<Tutee>
{
    ...
    public fromDataMatrix() {
        ...
        return rawData.map(tutee => {
            return {
                ...
                educationLevel: tutee['educationLevel'] !== EducationLevel.undefined ? (tutee['educationLevel'] as EducationLevel[])[0] : EducationLevel.undefined,
                ...
                subjects: (tutee['subjects'] as string[][])
                    .map(col =>
                        col.map(subject => {
                            try {
                                return educationLevelSubjectMappingMapping[
